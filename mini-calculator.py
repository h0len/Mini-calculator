...
print("Добро пожаловать в калькулятор! Введите выражение в формате: {первое число} {операция} {второе число}\nПример: \"двадцать три минус девятнадцать\""
      ...
      "\nВНИМАНИЕ: при вводе числа с ненулевой десятичной частью, вводите запрос в формате: \"{целая часть} и {десятичная часть с разрядом в конце. Пример: двадцать пять сотых}\"")
